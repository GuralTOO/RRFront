// analytics-cube-light.js
export const AnalyticsCubeLight = () => (
    <g id="analytics-cube-light">
      ...
      <svg width="390" height="430" viewBox="0 0 390 430" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <ellipse cx="301.631" cy="222.602" rx="1.50671" ry="1.5067" fill="#E2E2E2"/>
        <ellipse cx="326.643" cy="108.326" rx="2.51118" ry="2.49456" fill="#D2D2D2"/>
        <ellipse cx="350.85" cy="222.602" rx="2.51118" ry="2.51117" fill="#E2E2E2"/>
        <ellipse cx="251.621" cy="92.2916" rx="1.00447" ry="1.00447" fill="#D2D2D2"/>
        ...
        <ellipse cx="289.076" cy="240.369" rx="4.14553" ry="4.14552" fill="#3B82F6"/>
        <ellipse cx="140.212" cy="242.004" rx="2.51118" ry="2.51117" fill="#3B82F6"/>
        <ellipse cx="216.001" cy="151.754" rx="2.19201" ry="2.19201" transform="rotate(18.0323 216.001 151.754)" fill="#3B82F6"/>
        <ellipse cx="260.8" cy="116.631" rx="2.51118" ry="2.51117" transform="rotate(18.0323 260.8 116.631)" fill="#3B82F6"/>
        <ellipse cx="175.95" cy="243.009" rx="3.51565" ry="3.51564" fill="#3B82F6"/>

        <ellipse cx="195.676" cy="218.177" rx="2.51118" ry="2.51117" fill="#3B82F6"/>
        <ellipse cx="212.84" cy="208.223" rx="2.00894" ry="2.00894" fill="#3B82F6"/>
        </g>
        <defs>
